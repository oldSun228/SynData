...
import cn.seisys.iti.pdd.tcdp.syndata.manage.source1.entity.ExcelDataEntity;
...
public class ExcelReader {
    ...
    private static ExcelDataEntity convertRowToData(Row row) {
        ...
        cell = row.getCell(cellNum++);
        String li57 = convertCellValueToString(cell);
        resultData.setLi56(li57);

        cell = row.getCell(cellNum++);
        String li58 = convertCellValueToString(cell);
        resultData.setLi56(li58);

        cell = row.getCell(cellNum++);
        String li59 = convertCellValueToString(cell);
        resultData.setLi56(li59);

        cell = row.getCell(cellNum++);
        String li60 = convertCellValueToString(cell);
        resultData.setLi56(li60);

        cell = row.getCell(cellNum++);
        String li61 = convertCellValueToString(cell);
        resultData.setLi51(li61);

        cell = row.getCell(cellNum++);
        String li62 = convertCellValueToString(cell);
        resultData.setLi52(li62);

        cell = row.getCell(cellNum++);
        String li63 = convertCellValueToString(cell);
        resultData.setLi53(li63);

        cell = row.getCell(cellNum++);
        String li64 = convertCellValueToString(cell);
        resultData.setLi54(li64);

        cell = row.getCell(cellNum++);
        String li65 = convertCellValueToString(cell);
        resultData.setLi55(li65);

        cell = row.getCell(cellNum++);
        String li66 = convertCellValueToString(cell);
        resultData.setLi56(li66);

        cell = row.getCell(cellNum++);
        String li67 = convertCellValueToString(cell);
        resultData.setLi56(li67);

        cell = row.getCell(cellNum++);
        String li68 = convertCellValueToString(cell);
        resultData.setLi56(li68);

        cell = row.getCell(cellNum++);
        String li69 = convertCellValueToString(cell);
        resultData.setLi56(li69);

        cell = row.getCell(cellNum++);
        String li70 = convertCellValueToString(cell);
        resultData.setLi56(li70);

        cell = row.getCell(cellNum++);
        String li71 = convertCellValueToString(cell);
        resultData.setLi51(li71);

        cell = row.getCell(cellNum++);
        String li72 = convertCellValueToString(cell);
        resultData.setLi52(li72);

        cell = row.getCell(cellNum++);
        String li73 = convertCellValueToString(cell);
        resultData.setLi53(li73);

        cell = row.getCell(cellNum++);
        String li74 = convertCellValueToString(cell);
        resultData.setLi54(li74);

        cell = row.getCell(cellNum++);
        String li75 = convertCellValueToString(cell);
        resultData.setLi55(li75);

        cell = row.getCell(cellNum++);
        String li76 = convertCellValueToString(cell);
        resultData.setLi56(li76);

        cell = row.getCell(cellNum++);
        String li77 = convertCellValueToString(cell);
        resultData.setLi56(li77);

        cell = row.getCell(cellNum++);
        String li78 = convertCellValueToString(cell);
        resultData.setLi56(li78);

        cell = row.getCell(cellNum++);
        String li79 = convertCellValueToString(cell);
        resultData.setLi56(li79);

        cell = row.getCell(cellNum++);
        String li80 = convertCellValueToString(cell);
        resultData.setLi56(li80);
